...
<head>
    ...
    <style>
        ...
        @media print {{
            ...
            .ticket-box {{ border: none; width: 10cm; height: 15cm; padding: 4mm 5mm; }}
        }}
    </style>
</head>
<body>
    <div class="ticket-box">
        ...
        <div style="text-align: center; font-size: 10px; color: #555; padding-top: 2px; border-top: 1px dashed #ddd;">
